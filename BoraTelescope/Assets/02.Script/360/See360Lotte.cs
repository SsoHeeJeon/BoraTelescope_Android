...
public class See360Lotte : MonoBehaviour
{
    ...
    public string currentmode = "Current";
    ...
    float labelON;
    float labelOFF;
    public Image[] OnLabel;
    public Image[] OffLabel;
    ...
    {
        PastModeLabelOn = false;
        gamemanager.modeonoff.PastMode.transform.GetChild(0).gameObject.SetActive(false);
        if (SceneManager.GetActiveScene().name.Contains("ClearMode"))
        {
            ...
            //gamemanager.clearMode.but360.SetActive(true);
            //ClearModeLotte.changeZoom = new Vector3(0, 0, -3369);
            //gamemanager.clearMode.Main.transform.parent.gameObject.transform.position = new Vector3(0, 0, -3369);
            //gamemanager.moveannounce.CloseObj();
        ...
        //    moveTime.transform.GetChild(0).transform.GetChild(index).gameObject.GetComponent<Button>().enabled = true;
        //}
        //obj360.transform.parent.parent = gamemanager.see360.gameObject.transform;
        ...
        //gamemanager.Arrow.SetActive(false);gamemanager.MiniMap_Background.transform.parent.gameObject.SetActive(true);
        //gamemanager.Tip_Obj.SetActive(false);

        //gamemanager.CaptureSelfi.SetActive(false);

        //for (int index = 0; index < gamemanager.navilabel.transform.childCount; index++)
        //{
        //    gamemanager.navilabel.transform.GetChild(index).gameObject.GetComponent<Button>().enabled = true;
        //}
        currentmode = "Current";
        ChangeImage(currentmode);
        ...
        for (int i = 0; i < Label80.transform.childCount; i++)
        {
            Label80.transform.GetChild(i).GetComponent<Image>().color = new Color(1, 1, 1, 0);
        }

        for (int i = 0; i < LabelCur.transform.childCount; i++)
        {
