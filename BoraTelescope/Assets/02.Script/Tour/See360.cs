...
public class See360 : MonoBehaviour
{
    ...
    public void SeeAllRound()
    {
        if (Input.touchCount == 1 || Input.GetMouseButtonDown(0))
        {
            ...
            else if (Input.touches[0].phase == TouchPhase.Ended || Input.GetMouseButtonUp(0))
            {
                fx = 0;
                fy = 0;
                obj360.transform.rotation = Quaternion.Euler(obj360.transform.rotation.eulerAngles.x, obj360.transform.rotation.eulerAngles.y, obj360.transform.rotation.eulerAngles.z);
                dontclick = false;
                gosecond = false;
                dragmove_t = 0;
    ...
    {
        obj360.transform.rotation = Quaternion.Euler(obj360.transform.rotation.eulerAngles.x, obj360.transform.rotation.eulerAngles.y + fx * 0.5f, obj360.transform.rotation.eulerAngles.z);
