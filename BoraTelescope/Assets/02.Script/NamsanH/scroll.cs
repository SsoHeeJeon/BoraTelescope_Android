        ...
        if(DisText)
        {
            switch(GameManager.langstate)
            {
                case GameManager.LangState.Korea:
                    Title_KE.transform.parent.parent.GetComponent<Image>().fillAmount -= Time.deltaTime * 0.28f;
                    break;
                case GameManager.LangState.English:
                    Title_KE.transform.parent.parent.GetComponent<Image>().fillAmount -= Time.deltaTime * 0.28f;
                    break;
                case GameManager.LangState.Chienses:
                    Title_C.transform.parent.parent.GetComponent<Image>().fillAmount -= Time.deltaTime * 0.28f;
                    break;
                case GameManager.LangState.Japan:
                    Title_J.transform.parent.parent.GetComponent<Image>().fillAmount -= Time.deltaTime * 0.28f;
                    break;
            }
        }
