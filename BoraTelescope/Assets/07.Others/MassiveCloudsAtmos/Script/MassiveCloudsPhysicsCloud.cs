...
namespace Mewlist.MassiveClouds
{
    ...
    public class MassiveCloudsPhysicsCloud : AbstractMassiveClouds
    {
        ...
        public override void BuildCommandBuffer(CommandBuffer commandBuffer, Camera targetCamera, RenderTargetIdentifier source,
            RenderTargetIdentifier destination)
        {
            ...
            CommandBufferUtility.BlitProcedural(commandBuffer, renderTextures.From, destination);
