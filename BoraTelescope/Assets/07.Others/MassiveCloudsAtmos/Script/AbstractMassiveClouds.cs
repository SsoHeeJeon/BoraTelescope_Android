...
namespace Mewlist.MassiveClouds
{
    public abstract class AbstractMassiveClouds : ScriptableObject
    {
        ...
        public abstract void BuildCommandBuffer(CommandBuffer commandBuffer, Camera targetCamera, RenderTargetIdentifier source, RenderTargetIdentifier destination);
